...
final class WebhookTest extends TestCase
{
  ...
  public function testValidateWebhookStaticCall(): void
  {
    ...
    $this->assertTrue($a,
      'When "\BTCPayServer\Client\Webhook::isIncomingWebhookRequestValid()" is called as a class member method it should return true.');
    ...
    $this->assertTrue($b,
      'When "\BTCPayServer\Client\Webhook::isIncomingWebhookRequestValid()" is called statically it should return true.');
  }
}
